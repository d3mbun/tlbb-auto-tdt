namespace _i
{
    ...
    public abstract class InjectionMethod : ErrorBase
    {
        ...
        public virtual IntPtr Inject(_i.PortableExecutable image, int processId)
        {
            this.ClearErrors();
        ...
        public abstract IntPtr Inject(_i.PortableExecutable image, IntPtr hProcess);
        ...
        public virtual IntPtr[] InjectAll(_i.PortableExecutable[] images, int processId)
        {
            this.ClearErrors();
            IntPtr hProcess = WinAPI.OpenProcess(0x43a, false, processId);
        ...
        public abstract IntPtr[] InjectAll(_i.PortableExecutable[] images, IntPtr hProcess);
