namespace _i
{
    ...
    internal abstract class StandardInjectionMethod : InjectionMethod
    {
        ...
        public override IntPtr Inject(_i.PortableExecutable dll, IntPtr hProcess)
        {
            this.ClearErrors();
        ...
        public override IntPtr[] InjectAll(_i.PortableExecutable[] dlls, IntPtr hProcess)
        {
            this.ClearErrors();
            return this.InjectAll(Array.ConvertAll<_i.PortableExecutable, string>(dlls, pe => Utils.WriteTempData(pe.ToArray())), hProcess);
        }
