namespace _i
{
    ...
    {
        public ResourceWalker(_i.PortableExecutable image)
        {
        ...
        public class ResourceDirectory : ResourceWalker.ResourceObject
        {
            ...
            public ResourceDirectory(_i.PortableExecutable owner, IMAGE_RESOURCE_DIRECTORY_ENTRY entry, bool named, uint root) : base(owner, entry, named, root)
            {
        ...
        public class ResourceFile : ResourceWalker.ResourceObject
        {
            ...
            public ResourceFile(_i.PortableExecutable owner, IMAGE_RESOURCE_DIRECTORY_ENTRY entry, bool named, uint root) : base(owner, entry, named, root)
            {
        ...
        public abstract class ResourceObject
        {
            ...
            protected _i.PortableExecutable _owner;
            protected uint _root;

            public ResourceObject(_i.PortableExecutable owner, IMAGE_RESOURCE_DIRECTORY_ENTRY entry, bool named, uint root)
            {
                this._owner = owner;
                this._entry = entry;
