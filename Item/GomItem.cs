...
namespace _i
{
    public partial class GomItem : UserControl
    {
        public GomItem()
        {
            InitializeComponent();
        ...
        {
            SettingOld.GomName = txtName.Text;
